...
var _githubInjection = require('github-injection');
...
},{"./plugin":6,"./state":8,"github-injection":1}],4:[function(require,module,exports){
'use strict';
...
var PullRequest = (function () {
  ...
  _createClass(PullRequest, [{
    key: 'init',
    value: function init() {
      (0, _jQuery2.default)('.sidebar-milestone').hide();
    }
  }]);
...
var Plugin = function Plugin() {
  ...
  this.plugins = {
    red: new _red2.default()
  };
};

exports.default = Plugin;

},{"./plugins/red":7}],7:[function(require,module,exports){
'use strict';
...
var _repository = require('./pages/repository');

var _repository2 = _interopRequireDefault(_repository);

var _pullRequest = require('./pages/pull-request');
...
var State = (function () {
  ...
  _createClass(State, [{
    ...
    key: 'detectPage',
    value: function detectPage() {
      var path = window.location.pathname;

      if (_pullRequest2.default.detect(path)) {
        return new _pullRequest2.default();
      } else if (_repository2.default.detect(path)) {
...
},{"./pages/pull-request":4,"./pages/repository":5}]},{},[3]);
